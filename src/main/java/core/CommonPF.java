	...
	static void getWebDriver(String browser) {
		...
		if (browser.equalsIgnoreCase("firefox")) {
			if (System.getProperty("os.name").toUpperCase().contains("MAC"))
				driverPath = "/Users/pavel_luzhinskii/Workspace/HW_41/geckodriver";
			...
			if (System.getProperty("os.name").toUpperCase().contains("MAC"))
				driverPath = "/Users/pavel_luzhinskii/Workspace/HW_41/chromedriver";
			else if (System.getProperty("os.name").toUpperCase().contains("WINDOWS"))
...
//            System.out.println(test_case + (isElementPresent(by) ? " - exists" : " -
//              not exist") + "; Page [" + getFileName() + "]");}
	public static void pageValidation(String test_case, WebElement element) {
		System.out.println(test_case + (isElementPresent(element) ? " - exists" : " -not exist") + "; + Page ["
				+ getFileName() + "]");
	}
